...
namespace Alugamer.Utils
{
    ...
    public class Erro
    {
        private readonly string erroGenerico = "Erro Desconhecido! Contate o Administrador.";
        private readonly string erro404 = "Página não encontrada!";
        private readonly string erroGenericoDatabase = "Erro ao Acessar o Banco de Dados! Tente novamente mais tarde ou Contate o Administrador!";
